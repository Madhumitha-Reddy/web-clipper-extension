...
aliases:
  - Web Clipper
  - Extending Obsidian/Web Clipper
cssclasses:
  - list-cards
  - list-cards-mobile-full
permalink: web-clipper
---
Web Clipper is a free browser extension that lets you highlight pages and save web content to your vault.
...
Get the Web Clipper extension from the official directory for your browser:
...
- [[Web Clipper/Templates|Templates]]
...
Web Clipper saves content locally to your Obsidian vault and follows our [privacy policy](#). Your data is not collected, and we do not gather any usage metrics. The code is [open source](https://github.com/Madhumitha-Reddy/web-clipper-extension) and auditable.