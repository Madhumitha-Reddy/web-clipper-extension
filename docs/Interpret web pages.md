...
aliases:
  - Interpreter
---
Interpreter is a [[Introduction to Web Clipper|Web Clipper]] feature that lets you interact with web pages using natural language. Interpreter helps you capture and modify data that you want to save to Obsidian. For example:
...
Interpreter leverages language models to process information on a web page, and return results using [[Variables]] that you can add to your [[Web Clipper/Templates|Web Clipper Templates]].
...
4. Add [[Variables|prompt variables]] to your [[Web Clipper/Templates|templates]].
...
You can override the default context in Interpreter **Advanced settings** and define context per [[Web Clipper/Templates|template]].
