...
---
Filters allow you to modify [[variables]] in [[Web Clipper/Templates|Web Clipper templates]]. Filters are applied to variables using the syntax `{{variable|filter}}`.
