...
aliases:
  - Web Clipper/Capture web pages
---
Once you install the [[Introduction to Web Clipper|Web Clipper]] browser extension, you can access it in several ways, depending on your browser:
...
When you open the extension, Web Clipper extracts data from the current web page following the settings in your [[Web Clipper/Templates|template]]. You can create your own templates, and customize the output using [[variables]] and [[filters]].
...
- **Template** dropdown to switch between your saved [[Web Clipper/Templates|templates]] added in Web Clipper settings.
